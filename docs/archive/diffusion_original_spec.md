...
> Archived original implementation specification. The maintained project guide is `README.md`; implementation deviations are now tracked in `docs/implementation_notes.md`.
...
1. Record the change in `docs/implementation_notes.md`.
...
If numerical failure occurs because daily covariance values are too small, increase the ridge minimally and record the final value in `docs/implementation_notes.md`.
